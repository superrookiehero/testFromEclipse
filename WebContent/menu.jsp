							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 产品管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="jsp/product/add.jsp" 
														target=main>－ 新增产品</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="product/findAll.action"
														target=main>－ 产品列表</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 订单管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												 <TR>
													<TD class=menuSmall><A class=style2 href="order/findoption.action"
														target=main>－ 新增订单</A></TD>
												</TR> 
												<TR>
													<TD class=menuSmall><A class=style2 href="order/findOrder.action"
								...
								<TR>
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="role/findAllRole.action"
														target=main>－角色管理</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="user/findAllUser.action"
														target=main>－用户管理</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="permission/findAllPermission.action"
