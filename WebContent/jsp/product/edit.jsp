...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/product/upProductById.action?id=${product.id}"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="departureTime" value="<fmt:formatDate value="${product.departureTime }" pattern="yyyy-MM-dd HH:mm:ss"/>">
								</td>
							</TR>
							...
							<TR>
								...
								<td>其他信息 ：</td>
								<td colspan="2">
									<textarea rows="3" style="WIDTH: 180px" cols="1" maxLength=50 name="productDesc" >${product.productDesc}</textarea>
								</td>
							</TR>
