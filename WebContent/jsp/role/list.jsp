...
<SCRIPT language=javascript>
	...
	function add(){
		window.location.href="${pageContext.request.contextPath }/jsp/role/add.jsp";
	}
	
	function choose(id,roleName){
		var pw=window.opener;
		pw.document.getElementById("id").value=id;
		pw.document.getElementById("roleName").value=roleName;
		window.close();
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：角色管理 &gt; 角色列表</TD>
							</TR>
							<TR>
								<TD height=2>
								<INPUT class=button id=sButton2 onclick="add()" type="button"
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/role/findThePermission.action?id=${role.id}">查看详情</a>
													&nbsp;&nbsp;
												...
												<tr><td>
												<c:if test="${flag==selected}">
													<a href="#" onclick="choose('${role.id}','${role.roleName }')">提交</a>
												</c:if>
